package com.marno.mbasiclib.ui;
...
import com.marno.mbasiclib.extras.TabEntity;
 ...
 * 快速创建主页布局
 */
public abstract class RapidMainActivity extends MBasicActivity {
     ...
     */
    @NonNull
    protected abstract int[] getTabUnselectedIcon();
     ...
     */
    @NonNull
    protected abstract int[] getTabSelectedIcon();
